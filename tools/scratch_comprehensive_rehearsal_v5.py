...
BASE = "491419509f148fa64b830f05397d6b00bd1feff1"
SEAL = "883753c557343124eeeaf229717e0c8cff47190c6ac8983ace6e43e89a8f5830"
...
def main():
    if len(sys.argv) != 3:
        raise SystemExit("usage: scratch_comprehensive_rehearsal_v5.py REPO ARTIFACT_DIR")
    ...
    assert "VENUE_REGISTRY_FALLBACK" not in ohio.get("notes", "")
